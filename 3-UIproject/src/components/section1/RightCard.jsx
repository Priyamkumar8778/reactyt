  ...
  return (
    <div className="shrink-0 h-full w-80 overflow-hidden relative rounded-4xl">
      ...
      <div className="absolute left-0 top-0 h-full w-full p-8 flex flex-col justify-between ">
        ...
        <p className="text-xl leading-normal text-white mb-10 pt-110">
          {props.text}
        </p>
        <div className="flex justify-between">
          ...
          <button className="mt-0 flex items-center justify-center bg-blue-600 text-white font-medium px-4 py-2 rounded-full">
            <ArrowRight />
          </button>
        </div>
      </div>
